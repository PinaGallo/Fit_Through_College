...
def main_fitness():
    ...
    if not st.session_state['authentication']:
        ...
        st.markdown("<h2 style='color: #ff5733;'> <b>Fit through College</b> </h2>", unsafe_allow_html=True)
        
        st.subheader('Your individual training plan that keeps you fit through college')
